...
class API extends common_1.Common {
    ...
    config() {
        ...
        router.post('/editApprover', awaitAppDelegateFactory((request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                let data = request.body;
                const mongoData = yield index_1.default.editApprover(data);
...
//# sourceMappingURL=workflow_api.js.map